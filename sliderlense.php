...
class SliderLense {
	...
	public function sl_load_assets() {
		...
		wp_register_style( 'sliderlense-css', SL_PLUGIN_URL . 'css/sliderlense.css', array(), time(), 'all' );
		wp_register_style( 'slick-lense-css', SL_PLUGIN_URL . 'css/slick/slick.css', array(), false, 'all' );
		wp_register_style( 'slick-theme-lense-css', SL_PLUGIN_URL . 'css/slick/slick-theme.css', array( 'slick-lense-css' ), false, 'all' );
		wp_register_style( 'animate-css', SL_PLUGIN_URL . 'css/animate/animate.min.css', array(), '4.1.1', 'all' );
		wp_register_script( 'slick-lense-js', SL_PLUGIN_URL . 'js/slick/slick.js', array( 'jquery' ), false, true );
		wp_register_script( 'sliderlense-js', SL_PLUGIN_URL . 'js/sliderlense.js', array( 'jquery', 'slick-lense-js' ), time(), 'all' );
